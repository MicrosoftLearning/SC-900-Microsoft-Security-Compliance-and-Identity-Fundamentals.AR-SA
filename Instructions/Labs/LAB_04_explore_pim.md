...
1. سَجِّل الدخول باستخدام بيانات اعتماد مسؤول Microsoft 365 المقدمة من ALH.
    ...
    1. إذا قمت بتسجيل الدخول مسبقا كمسؤول، فقد تتم مطالبتك بإكمال مصادقة ثانوية، كجزء من المصادقة متعددة العوامل. إذا لم تكن قد سجلت الدخول مسبقا كمسؤول، فقد تتم مطالبتك بإكمال عملية تسجيل المصادقة متعددة العوامل. اتبع المطالبات التي تظهر على الشاشة لإعداد المصادقة متعددة العوامل.
...
1. أنت الآن في صفحة البداية السريعة لإدارة الهويات المتميزة. راجع المعلومات في صفحة البدء. في النافذة الرئيسية، ضمن المكان الذي تظهر فيه عبارة إدارة الوصول، حدد **إدارة**.
...
1. سجل الدخول باسم Diego Siciliani.
    ...
    1. نظرا لأن هذه هي المرة الأولى التي تقوم فيها بتسجيل الدخول ك Diego، فقد تتم مطالبتك بإعداد MFA. اتبع المطالبات التي تظهر على الشاشة لإعداد المصادقة متعددة العوامل.
    1. عند مطالبتك بالبقاء مسجلاً للدخول، حدد **نعم**.
...
1. بمجرد إكمال عملية تسجيل MFA، يتم إرجاعك إلى صفحة مسؤول PIM Active-User.
...
1. بصفتك مسؤول مستخدم Microsoft Entra ID، يمكنك إنشاء مستخدمين ومجموعات وإدارة التراخيص والمزيد. من لوحة التنقل اليسرى، قم بتوسيع **Identity**، وحدد **Users**.
1. من قائمة المستخدمين، حدد **Bianca Pisani**.
1. من لوحة التنقل اليسرى، حدد **المجموعات**.
1. لاحظ المجموعات التي تم تعيين Bianca إليها بالفعل. من أعلى الصفحة، حدد **+ Memberships**.
1. من قائمة المجموعات، حدد **Mark 8 Project Team**.
1. من أسفل الصفحة، حدد **Select**.
1. في صفحة المجموعات، لاحظ أنه تمت إضافة مجموعة Mark 8 Project Team إلى القائمة (إذا لم ترها مدرجة على الفور، فحدد **الزر Refresh** ).
1. سجّل الخروج من خلال تحديد أيقونة المستخدم بجوار عنوان البريد الإلكتروني في الزاوية العلوية اليمنى من الشاشة وحدّد **تسجيل الخروج**. ثم أغلق جميع نوافذ المستعرض.
1. تقتصر مدة دور مسؤول المستخدم على الوقت الذي تم تكوينه.

### المراجعة

في هذا النشاط المعملي؛ استكشفت PIM.  قمت -بصفتك المسؤول- بتكوين Diego بامتيازات مسؤول المستخدم لفترة محددة من الوقت.  ثم قمت، ك Diego، بمسار عملية تنشيط امتيازات مسؤول المستخدم والمستخدم إلى مجموعة.  تذكر أن PIM يتطلب ترخيص Microsoft Entra ID Premium P2.

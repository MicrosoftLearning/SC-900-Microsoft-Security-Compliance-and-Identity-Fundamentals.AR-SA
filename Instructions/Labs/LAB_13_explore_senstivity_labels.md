<div id="readme" class="Box-body readme blob js-code-block-container p-5 p-xl-6 gist-border-0" dir="rtl">
  ...
  <tbody>
  <tr>
  <td><div>استكشاف أوصاف الحساسية في Microsoft 365</div></td>
...
1. حدد علامة تبويب **الأوصاف** من أعلى الصفحة.

1. يظهر مربع معلومات أصفر يشير إلى أن "مؤسستك لم تقم بتشغيل القدرة على معالجة المحتوى في ملفات Office عبر الإنترنت حيث تم تطبيق أوصاف الحساسية المشفرة والمخزنة في OneDrive وSharePoint..."  حدد تشغيل الآن.  بمجرد القيام بذلك، يمكن أن يحدث تأخير لنشر الإعداد عبر النظام.


1. في منتصف الصفحة، لاحظ كيف توجد أوصاف تم إنشاؤها بالفعل.  حدد **سرية - تمويل**.  تفتح نافذة توفر معلومات حول هذا الوصف.  لاحظ كيف تم تعيين هذا الوصف لدعم كل من التشفير وعلامة المحتوى.  حدد تحرير الوصف في الجزء العلوي من الصفحة لعرض بعض إعدادات التكوين الأساسية.
...
1. راجع إعدادات النهج.  لا تغير أي إعدادات.  حدد **التالي** في أسفل الصفحة.
    1. اقرأ الوصف الموجود ضمن "تطبيق تسمية افتراضية على المستندات".  لاحظ عدم وجود تسمية افتراضية. لا تغير أي إعدادات.  حدد **التالي** في أسفل الصفحة.
    1. اقرأ الوصف الموجود ضمن "تطبيق تسمية افتراضية على رسائل البريد الإلكتروني".  حدد سهم القائمة المنسدلة في مربع الإدخال لعرض الخيارات المتاحة. لا تغير أي إعدادات.  حدد **التالي** في أسفل الصفحة.
    1. اقرأ الوصف الموجود ضمن "تطبيق تسمية افتراضية على محتوى Power BI".  لاحظ عدم وجود تسمية افتراضية. لا تغير أي إعدادات.  حدد **التالي** في أسفل الصفحة.
...
1. تأكد أولاً من أن لديك إعداد Office على جهازك الظاهري (VM) الخاص بالنشاط المعملي.  لإجراء ذلك، حدد علامة تبويب **مركز مسؤولي Microsoft 365** التي تفتح المستعرض.  إذا كنت قد أغلقت علامة التبويب مسبقًا، فافتح علامة تبويب جديدة في المستعرض وأدخل **admin.microsoft.com**.
    1. من لوحة التنقل اليمنى، حدد **الفوترة** لعرض جميع الخيارات، ثم حدد **منتجاتك**.
    1. من صفحة منتجاتك، حدد **الإصدار التجريبي Microsoft 365 E5**
    1. من صفحة الإصدار التجريبي Microsoft 365 E5، حدد **تنزيل البرنامج وتثبيتها** واتبع الإرشادات الموجودة على الصفحة.

1. من الزاوية اليسرى السفلية للجهاز الظاهري الخاص بالنشاط المعملي، حدد أيقونة Windows، ثم حدد **Word** ثم حدد **مستند فارغ**.  سيؤدي هذا إلى فتح مستند Word جديد باستخدام إصدار سطح المكتب من Word.

1. من شريط القائمة العلوي، حدد **الحساسية**. من القائمة المنسدلة، حدد **سرية - تمويل**.

1. لاحظ كيف يتضمن المستند العلامة المائية.  ستظهر العلامة المائية بنص صغير رمادي فاتح معروض رأسيًا على الصفحة. 

1. احفظ ملف Word.

1. أغلق علامات تبويب Microsoft Word المفتوحة في مستعرضك للخروج من Word.

#### المهمة 3 (اختيارية): بالإضافة إلى تمييز المحتوى، تم تعيين إعداد حماية الوصف للتشفير. وفقًا للأذونات التي تم تكوينها باستخدام هذا الوصف، يمكن لأعضاء مجموعة التمويل المشاركة في تأليف المستندات مع تطبيق هذا الوصف ويمكن للمستخدمين في مستأجر Contoso عرضها.  في هذه المهمة، سترسل هذا المستند إلى عنوان بريد إلكتروني يمكنك الوصول إليه (على سبيل المثال، عنوان بريد إلكتروني شخصي) وهذا ليس جزءًا من نطاق WWLxZZZZ.OnMicrosoft.com وانظر ماذا يحدث عندما تحاول فتح المرفق.  
...
1. باستخدام مستعرض الويب على الجهاز الظاهري الخاص بالنشاط المعملي، سجّل الدخول إلى حساب البريد الإلكتروني الذي أرسلتَ المستند إليه.  ملاحظة، قد يتم توجيه البريد الإلكتروني إلى مجلد البريد غير الهام خاصتك.  عندما تحاول فتح ملف Word المرفق، سترى إشعارًا بأنه ليس لديك إذن لفتح المستند.

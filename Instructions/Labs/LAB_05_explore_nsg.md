...
1. من لوحة التنقل اليسرى، حدد **إعدادات الشبكة**.  تعرض أقسام الأساسيات في النافذة الرئيسية واجهة الشبكة للجهاز الظاهري.  لاحظ أنه لا يوجد أي شيء مدرج بجوار مجموعة أمان الشبكة، حيث لم تُعين NSG للواجهة.
...
1. يمكن التبديل مرة أخرى إلى علامة التبويب **SC900-WinWM - Microsoft Azure** في المستعرض.  قم بتحديث الصفحة. بجوار المكان الذي تظهر فيه مجموعة أمان الشبكة، يمكن أن ترى يويو الآن اسم NSG الذي أنشأته للتو.  إذا كنت لا تزال لا ترى ذلك، فانتظر دقيقة أخرى ثم عليك تحديث الصفحة مرة أخرى.

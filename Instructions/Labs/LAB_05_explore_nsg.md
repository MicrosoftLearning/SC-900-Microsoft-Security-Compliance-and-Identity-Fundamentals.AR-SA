...
1. من أعلى الصفحة، حدد **الاتصال**.  حدد خيار **التحقق من الوصول**، المدرج تحت عنوان IP.  سيتم إجراء هذا الفحص باستخدام المنفذ 3389، وهو منفذ اتصال RDP.  ينبغي أن ترى الرسالة "لا يمكن التحقق".  من مربع RDP الأصلي، انقر فوق **تحديد**.  في النافذة التي تفتح، ضمن "1 تكوين المتطلبات الأساسية لـ Native RDP"، سترى "يحتاج Azure إلى تكوين بعض الميزات من أجل الاتصال بالجهاز الظاهري".  في المهمة التالية، ستتولى بإعداد NSG للسماح بشكل صريح باتصال RDP.
...
1. من علامة تبويب NSG المفتوحة، *انقر بزر الماوس الأيمن* فوق رابط **الصفحة الرئيسية** في الجزء العلوي من الصفحة وحدد **فتح الارتباط في علامة تبويب جديدة** لفتح صفحة أخرى لخدمات Azure.
...
1. افتح علامة تبويب SC900-WinVM – Microsoft Azure في المستعرض. إذا أغلقتَ مسبقًا علامة تبويب المستعرض، فافتح علامة تبويب جديدة في المستعرض، وأدخل **الأجهزة الافتراضية** وحددها **https://portal.azure.com**، ثم حدد الجهاز الظاهري، **SC900-winVM**.

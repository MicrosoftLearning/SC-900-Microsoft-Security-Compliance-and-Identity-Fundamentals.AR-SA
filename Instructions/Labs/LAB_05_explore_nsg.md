<!---
---
النشاط المعملي: العنوان: "استكشاف مجموعات أمان شبكة Azure (NSG)" مسار التعلم/الوحدة النمطية/الوحدة: "مسار التعلم: وصف قدرات حلول الأمان من Microsoft؛ الوحدة النمطية 1: وصف قدرات الأمان الأساسية في Azure؛ الوحدة 6: وصف مجموعات أمان شبكة Azure"
---
--->
...
1. من لوحة التنقل اليسرى، حدد **Network الإعدادات**.  تعرض أقسام الأساسيات في النافذة الرئيسية واجهة الشبكة للجهاز الظاهري.  لاحظ أنه لا يوجد أي شيء مدرج بجوار مجموعة أمان الشبكة، حيث لم يتم تعيين NSG للواجهة.

1. اترك علامة التبويب هذه مفتوحة.
...
1. من علامة تبويب Azure المفتوحة، *انقر بزر الماوس* الأيمن **فوق الارتباط الصفحة الرئيسية** في أعلى الصفحة وحدد **فتح ارتباط في علامة تبويب** جديدة لفتح صفحة أخرى لخدمات Azure.
...
1. من وسط الصفحة، حدد الزر الأزرق المسمى **Create network security group**.  بدلا من ذلك، يمكنك تحديد **+ إنشاء** من أعلى صفحة مجموعات أمان الشبكة.
...
1. يجب أن تكون في صفحة النظرة العامة لمجموعة أمان الشبكة التي تم إنشاؤها حديثا.  إذا لم يكن الأمر كما هو، فحدد نظرة عامة** من لوحة **التنقل اليسرى. في أعلى الصفحة أسفل المكان المذكور فيه Essentials، سترى بعض المعلومات الأساسية حول مجموعة أمان الشبكة التي أنشأتها.  نقطتان يجب ملاحظتها هما أنه لا توجد قواعد أمان مخصصة ولا توجد شبكات فرعية ولا واجهات شبكة مرتبطة بمجموعة أمان الشبكة هذه.  على الرغم من عدم وجود قواعد أمان مخصصة، إلا أن هناك قواعد افتراضية للوارد والصادر مضمنة مع كل مجموعة أمان شبكة، كما هو موضح في الصفحة.  راجع قواعد الوارد والصادر. ترفض قواعد الوارد الافتراضية جميع عمليات نقل البيانات الواردة التي ليست من شبكة ظاهرية أو Azure load balancer.  ترفض قواعد الصادر جميع عمليات نقل البيانات الصادرة باستثناء عمليات نقل البيانات بين الشبكات الظاهرية وعمليات نقل البيانات الصادرة إلى الإنترنت.

1. من جزء التنقّل الأيسر في صفحة NSG-SC900، ضمن الإعدادات، حدد **واجهات الشبكة**.
    1. حدد **+ Associate.**
    2. في حقل "اقترانات واجهة الشبكة"، حدد **السهم لأسفل**، وحدد **sc900-winvmXXX**، ثم حدد **موافق** في أسفل النافذة. بمجرد ربط الواجهة بمجموعة أمان الشبكة، ستظهر في القائمة.  تم تعيين NSG الآن إلى واجهة شبكة الجهاز الظاهري الخاص بك.

1. قم بالتبديل مرة أخرى إلى **علامة التبويب SC900-WinWM - Microsoft Azure** على المستعرض.  قم بتحديث الصفحة. بجوار المكان الذي تظهر فيه مجموعة أمان الشبكة، يجب أن ترى uou الآن اسم NSG الذي أنشأته للتو.  إذا كنت لا تزال لا ترى ذلك، فانتظر دقيقة أخرى ثم قم بتحديث الصفحة مرة أخرى.

1. من لوحة التنقل اليسرى، حدد **الاتصال**. من النافذة الرئيسية، بجوار المكان الذي يظهر فيه رقم المنفذ 3389، حدد **التحقق من الوصول**. ترسل وظيفة الوصول إلى التحقق إشارات (نسبة استخدام الشبكة) إلى منفذ RDP الافتراضي 3389 من الجهاز الظاهري للتحقق مما إذا كان يمكن الوصول إليه. قد يستغرق الأمر دقيقة، ولكن سترى لا يمكن الوصول إليها.  هذا متوقع، لأن قاعدة DenyAllInBound NSG ترفض كافة نسبة استخدام الشبكة الواردة إلى الجهاز الظاهري.

1. قم بالتبديل مرة أخرى إلى **علامة التبويب NSG-SC900 - Microsoft Azure** في المستعرض.

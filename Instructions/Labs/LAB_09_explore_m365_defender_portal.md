...
# نشاط معملي: استكشاف مدخل Microsoft 365 Defender
...
1. من جزء التنقل الأيسر من مركز مسؤولي Microsoft 365، ضمن مسؤول center، حدد **Security**.  إذا كنت لا ترى "الأمان" في القائمة، فحدد **Show all**، ثم حدد **Security**.  يتم فتح صفحة مستعرض جديدة على صفحة الترحيب الخاصة بمدخل Microsoft 365 Defender.  
...
1. توفر لوحة التنقل اليسرى ارتباطات/وصولاً إلى المعلومات التي تعد جزءًا من الكشف والاستجابة الموسعة من Microsoft (حل XDR) والذي يتضمن الأحداث والتنبيهات، والتتبع، ومركز الإجراءات، وتحليلات المخاطر، ودرجة الأمان والمزيد.  كما يتضمن الوصول السريع إلى Microsoft Defender لنقطة النهاية (الارتباطات المدرجة ضمن نقاط النهاية)، Defender ل Office ل 365 (الارتباطات المدرجة ضمن البريد الإلكتروني والتعاون)، Microsoft Defender for Cloud Apps (الارتباطات ضمن تطبيقات السحابة).  استكشف هذه الخيارات بتحديد بعض الارتباطات.   للعودة إلى الصفحة الرئيسية لمدخل Microsoft 365 Defender، حدد **الصفحة الرئيسية** من لوحة التنقل اليسرى.

...
1. من جزء التنقل الأيمن، حدد **اللوائح**.  تسرد هذه الصفحة اللوائح المتوفرة لمؤسستك. حدد أي لائحة مدرجة. سوف ترى معلومات محددة حول هذه اللائحة، بما في ذلك عناصر التحكم وإجراءات التحسين وإجراءات Microsoft.
...
1. من جزء التنقل الأيمن، حدد **Alerts**.   يمكنك هنا عرض التنبيهات وإدارتها للأحداث التي يمكن أن تؤثر على درجة التوافق لمؤسستك. نظرا لأن هذا مستأجر مختبر تم إنشاؤه حديثا، يجب ألا ترى أي تنبيهات.

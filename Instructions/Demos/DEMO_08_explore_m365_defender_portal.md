<!---
---
العرض التوضيحي: العنوان: الوحدة النمطية "مدخل Microsoft Defender": "مسار التعلم: وصف قدرات حلول أمان Microsoft؛ الوحدة 4: وصف قدرات الحماية من التهديدات في Microsoft 365؛ الوحدة 7: وصف مدخل Microsoft Defender
---
--->
...
1. **التحليل الذكي** للمخاطر - من علامة التبويب تحليل ذكي للمخاطر، يصل المستخدمون إلى تحليل ذكي للمخاطر في Microsoft Defender ودعم القدرات، بما في ذلك تحليلات التهديدات وملفات تعريف intel ومستكشف intel ومشاريع intel.
...
1. تتضمن صفحة النظرة العامة أيضًا أهم الإجراءات الموصى بها ودرجة المقارنة والمحفوظات والموارد الإضافية.
...
في هذا العرض التوضيحي، استكشفت مدخل Microsoft Defender من خلال الاطلاع على المحتوى المعروض على الصفحة المقصودة، واستكشفت الخيارات على لوحة التنقل التي توفر وصولا سريعا إلى الوظائف التي تعد جزءا من حل الكشف والاستجابة الموسعة (XDR) من Microsoft، Microsoft Defender لنقطة النهاية s، و Microsoft Defender لـ Office 365 (البريد الإلكتروني والتعاون).  وأخيرًا، استكشفت أيضًا كيف يمكن لحل Microsoft Secure Score أن يساعد مؤسسة على تحسين وضعها الأمني.

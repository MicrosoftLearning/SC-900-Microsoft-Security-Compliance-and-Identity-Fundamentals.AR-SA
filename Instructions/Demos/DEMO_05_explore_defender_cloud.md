...
1. من أعلى الصفحة، حدد **الموارد المقيّمة**.  (لاحظ أن هذا يعادل تحديد المخزون من لوحة التنقل اليمنى لصفحة Microsoft Defender for Cloud الرئيسية).
    ...
    1. حدد **Microsoft Defender for Cloud** من الزاوية العلوية اليمنى من الشاشة للعودة إلى صفحة "نظرة عامة على Microsoft Defender for Cloud".

1. من أعلى الصفحة، حدد **التوصيات النشطة**.  (لاحظ أن هذا يعادل تحديد التوصيات من لوحة التنقل اليمنى لصفحة Microsoft Defender for Cloud الرئيسية).

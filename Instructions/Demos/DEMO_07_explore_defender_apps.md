...
1. باستخدام Microsoft 365 Defender for Cloud apps، يمكنك الاتصال بالتطبيقات مباشرة عن طريق إعداد موصلات التطبيقات التي ستمنحك رؤية أكبر وتحكمًا أكبر في تطبيقاتك السحابية.  من النقاط المهمة التي يجب توضيحها هي الرجوع إلى الوثائق للحصول على المتطلبات الأساسية لتوصيل موصلات تطبيق معينة. من الزاوية العلوية اليمنى من الشاشة، حدد **Actions** ثم حدد **Cloud Discovery Settings**.  من الجانب الأيسر من الشاشة، ضمن Connected apps، حدد **App connectors**.  
    1. في صفحة Connected apps، حدد *Office 365** من القائمة لعرض معلومات مفصلة. إذا كان Office 365 يعرض خطأ اتصال، فمن المرجح أن يكون ذلك بسبب عدم تشغيل Audit.  إذا تم تمكين audit، فانتقل إلى علامات الحذف العمودية على الجانب الأيمن من عنصر السطر، وحدد **edit settings**.  لإعادة الاتصال، حدد **Connect Office 365** أسفل الصفحة. يجب أن تظهر الصفحة الآن أن Office 365 متصل، حدد **Done**.  ستظهر الحالة الآن بعلامة تحذير صفراء، مما يشير إلى عدم وجود حالة حديثة.  سيستغرق تحديث الحالة بعض الوقت نظرًا لاختلاف الفترة الزمنية للفحص بأثر رجعي لكل تطبيق، وقد يواجه مستأجرو المختبر تأخيرات أطول من المعتاد (لا تتوقع تغيير الحالة أثناء العرض التوضيحي لأنه قد يستغرق عدة ساعات).
...
### <a name="demo-part-2---explore-the-cloud-app-catalog"></a>العرض التوضيحي - الجزء 2 - استكشاف كتالوج تطبيقات السحابة
...
### <a name="demo-part-3---explore-the-activity-log-and-files"></a>العرض التوضيحي الجزء 3 - استكشاف سجل النشاط والملفات
...
### <a name="demo-part-4---explore-policies"></a>العرض التوضيحي الجزء 4 - استكشاف النهج

<!---
---
العرض التوضيحي: العنوان: "استكشاف سير عمل eDiscovery" مسار التعلم/الوحدة/الوحدة النمطية: "مسار التعلم: وصف قدرات Microsoft Priva وMicrosoft Purview؛ الوحدة 3: وصف حلول التوافق مع البيانات من Microsoft Purview؛ الوحدة 2: وصف eDiscovery'
---
--->
...
في هذا النشاط المعملي، ستتعرف على الخطوات المطلوبة لإعداد eDiscovery، بما في ذلك إعداد أذونات الدور وإنشاء حالة eDiscovery وإنشاء احتجاز eDiscovery وإنشاء استعلام بحث.  ملاحظة: في مدخل Microsoft Purview، يتم طرح تحديثات واجهة المستخدم تدريجيا. قد لا يعرض بعض مستأجري المختبر/العرض التوضيحي أحدث واجهة مستخدم بعد، لذلك يتم عرض جميع خطوات المختبر باستخدام واجهة المستخدم eDiscovery الكلاسيكية.

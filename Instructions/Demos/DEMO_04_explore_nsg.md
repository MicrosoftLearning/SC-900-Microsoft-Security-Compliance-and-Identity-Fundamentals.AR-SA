...
1. من علامة تبويب الأساسيات، املأ المعلومات التالية (لأي شيء غير مدرج، اترك الإعدادات الافتراضية):
    ...
    1. **المنافذ الواردة العامة**: يمكنك ترك الإعدادات الافتراضية (لا يهم ما تحدده هنا لأن إعدادات الشبكة ستتجاوز ما تفعله هنا).
...
1. اختبر الآن قاعدة مجموعة أمان الشبكة الصادرة
    ...
    1. أدخل: **https://www.bing.com** . لا ينبغي عرض الصفحة. ملاحظة: إذا كنتَ قادرًا على الاتصال بالإنترنت وتحققتَ من تعيين جميع معلمات القاعدة الصادرة بشكلٍ صحيح، فمن المحتمل أن يستغرق الأمر بضع دقائق حتى تصبح القاعدة سارية المفعول. انتظر بضع دقائق وحاول مرة أخرى.

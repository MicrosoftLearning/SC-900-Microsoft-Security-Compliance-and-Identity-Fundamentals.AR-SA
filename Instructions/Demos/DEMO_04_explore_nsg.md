...
1. من علامة تبويب الأساسيات، املأ المعلومات التالية (لأي شيء غير مدرج، اترك الإعدادات الافتراضية):
    ...
    1. **المنافذ الواردة العامة**: يمكنك ترك الإعدادات الافتراضية (لا يهم ما تحدده هنا لأن إعدادات الشبكة ستمنع ما تفعله هنا).
...
1. أنت الآن في علامة تبويب الشبكات لتكوين الجهاز الظاهري.  املأ المعلومات التالية (لأي شيء غير مدرج، اترك الإعدادات الافتراضية):
    1. مجموعة أمان شبكة NIC: حدد **None**.  ملاحظة: باختيار "لا شيء" فإنك تضمن أن NIC ليس لديها مجموعة أمان الشبكة.  في خطوة لاحقة في العرض التوضيحي، ستنشئ مجموعة أمان الشبكة وتُعيّن الجهاز الظاهري NIC إلى مجموعة أمان الشبكة التي تُنشئها.
...
1. من أعلى الصفحة، حدد **اتصال** لأنه من المهم التحقق من قدرتك على الاتصال بالجهاز الظاهري.
    ...
    1. تفتح نافذة تطلب منك ببيانات الاعتماد خاصتك. إذا طلبت النافذة الافتراضية رقم تعريف شخصي، فحدد **المزيد من الخيارات**، ثم حدد **استخدام حساب مختلف**.   سيُطلب منك بيانات الاعتماد خاصتك.  أدخل كلمة المرور واسم المستخدم اللذان استخدمتهما عند إنشاء الجهاز الظاهري.
